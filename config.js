var config = {
    style: 'mapbox://styles/ianod/ck9a7113203aj1ik1kopcnvwx',
    ...
    subtitle: 'Stories from IFRC volunteers around the world responding to COVID-19',
    byline: '',
    footer: '',
    chapters: [
        {
            id: '0001',
            title: 'Take a tour of the IFRC Volunteer stories!',
            image: 'https://media.ifrc.org/ifrc/wp-content/uploads/sites/5/2020/03/pr_3.jpg',
            description: 'Scroll down to visit the IFRC volunteers from around the world telling their stories.',
            location: {
                center: [-87.18451, 20.30235],
                zoom: 0.9,
                pitch: 45,
                bearing: 0.00
            },
        ...
        {
            id: '0027',
            title: 'Situation in Hong Kong',
            image: '',
            description: '<p>Situation is not so good. The location near China and It arrived 4 months ago. HKRC kicked off the Level 3 emergency, no volunteers are allowed to have activities. Only staff can help. challenges of manpower mobilization in responding to the issue. </p><p>Online education for youth members. spread health information to the community.</p><p>Elderly have difficulties using digital tools. So it is a challenge for the Red Cross to help them. </p><p>In the general public, it is a bit of a panic. All the RC staff is working together.</p><p><i>Volunteer, Hong Kong Red Cross</i></p>',
            location: {
                center: [113.58834, 22.18387],
                zoom: 8.00,
                pitch: 45.00,
                bearing: 0.00
            },
        ...
        },
        {
            ...
            title: 'The Spray Men',
            image: '',
            description: 'There\’s a pin drop silence at the Hospital\’s Emergency Ward. When we arrived there it seems like all the doctors, nurses and staff are performing mannequin. We were really confused about what happened there and then we got to know that a patient tested positive for COVID-19 been brought there and died on the stretcher five minutes ago. That was the very first COVID-19 case for that hospital and everyone was in a little shock though they washed the floor already with bleaching water. We tried to assure them that there\’s nothing to worry about if we disinfect the place well and they can all continue their work there. Then we started disinfecting the whole place with our sprayer. We disinfected every bed, chambers, cabins, desks, chairs and all the people at the emergency ward at that time. And we noticed it worked really well, they were very much assured and started touching their equipment and working.<p><i>MD Elahi Rawshan, Bangladesh Red Crescent Society</i></p>',
            location: {
                center: [88.33974, 23.75138],
                zoom: 6.1,
                pitch: 45,
                bearing: 0.00
            },
        ...
        {
            id: '0101',
            title: 'A dilemma between staying home or risking to help',
            image: '',
            description: '<p>Most of the regions in the Philippines, if not all, are already under the Enhanced Community Quarantine which corresponds to a tighter implementation of the stay at home policy. As a committed volunteer, I opted to follow my desire to function as someone who could render humanitarian service in this time of crisis. However, I am also aware of the risk that I might end up infected because of the fact that COVID19 is a highly contagious disease. I made a choice of becoming part of the COVID19 response team of the Philippine Red Cross Compostela Valley Chapter (Davao de Oro), thus staying at home has become a second option. </p><p>To make sure that my family is safe, I stayed in the quarter and didn\’t visit my family to secure their safety at home. It\'s been over a month since I didn\’t come home because my tasks in the COVID19 response includes Profiling of PUM and PUI at the barangays within the jurisdiction of the Province. I also helped the welfare service at the quarantine site with 33 stranded passengers from Manila who can\’t pass through the region\’s border because of the regional lockdown implemented. All of the passengers are subject to 14 days quarantine because all persons who travel from Metro Manila are considered PUM. We initiated to craft face shields for the frontliners, intensify the promotion of handwashing, regularly disinfect areas that people usually visit, and more. </p><p>Going out of the comfort zone to do fieldwork has always been uncertain with the possibilities of having been infected with the infectious disease, but I have also understood the hard work of the staff in the call for this humanitarian noble service. They surely need more manpower to perform duties that are necessary for today\'s challenge not just in the Philippines, but also to the rest of the world who are facing this Pandemic.</p><p><i>Renz Jan D. Ontal, Philippine Red Cross</i></p>',
            location: {
                center: [117.10675, 12.20763],
                zoom: 4.7,
                pitch: 45,
                bearing: 0.00
            },
        ...
        {
            id: '0128',
            title: 'I think that the act of receiving the parcels was more important than the contents',
            image: '',
            description: '<p>I helped out delivering food parcels to people who were vulnerable and/or in self-isolation. I was very careful about social distancing but managed to connect with each family over the phone before arrival to arrange delivery. At times I was the only person they had spoken to for several days. It was so nice to be able to contribute and remain busy in a time when everyone felt so uncertain and scared. It was also good to be able to see that vulnerable people were being cared for in this way. Some people called me afterward to let me know how excited they were when they unpacked their boxes. For some, I think that the act of receiving the parcels was more important than the contents.</p><p>It has been a strange year, with so many bushfires and now COVID-19 has really impacted our connections to each other. Many people have no work and are worried and stressed.</p><p>I am now in quarantine due to work. Helping the Red Cross with deliveries assisted me with preparing for my own isolation so that I would remain mentally strong and able to adapt to challenges.</p><p>Hopefully, we will soon be able to get back to normal. It still doesn\'t feel real.</p><p><i>Andrea Porteous, Australian Red Cross<i><p>',
            location: {
                center: [121.51478, -28.05011],
                zoom: 3.5,
                pitch: 45,
                bearing: 0.00
            },
        ...
        {
            id: '0137',
            title: 'I learned that a lot of people can be stubborn and that we have to disseminate awareness messages continuously',
            image: '',
            description: 'Our branch initially called on us [volunteers] and we received training on how the virus spreads, how to avoid being infected, how to train others and how to disseminate messages through all media from home. They later called on us to train others including in markets and other highly frequented areas. They reassured us, as we had seen how the virus spread in China and the boom in Europe, and prepared us as the virus was coming towards us. The government declared a national quarantine, the National Society indicated that it followed the norms and we\'ve been confined for almost 3 weeks up to now. (...) A lot of people don\'t mind the request to stay home and are still going out and the virus is spreading. [In Bolivia], we have 210 confirmed cases and, in Santa Cruz de la Sierra, 7 fatalities. Personally, I learned that a lot of people can be stubborn and that we have to disseminate awareness messages continuously. I personally do so within my family and friends circle. Our filial doesn\'t have any resource, we\'re just respecting the quarantine, copying and disseminating information through social media. Nothing more than that.<p><i>Volunteer, Bolivian Red Cross<i><p>',
            location: {
                center: [-72.88765, -16.24945],
                zoom: 4.4,
                pitch: 45,
                bearing: 0.00
            },
        ...
        {
            id: '0109',
            title: 'We are proud and happy that it is based on volunteers engagement',
            image: '',
            description: 'With the engagement of volunteers, Polish Red Cross has just started psychological helpline where qualified psychologists and psychotherapists are on duty. Between 10:00 and 22:00, seven days a week, they provide psychological support to people who experience the negative effects of the pandemic. It includes psychoeducation, first psychological aid, providing information on places where specialist help can be obtained. Regular feedback is conducted concerning gender, age group, kind of problems beneficiaries are facing. The work of psychologists and psychotherapists is supervised by an expert. It is the very first helpline that the National Society is offering to the beneficiaries and we are proud and happy that it is based on volunteer engagement.<p><i>Magdalena Stefańska, Polish Red Cross<i><p>',
            location: {
                center: [16.18713, 51.74917],
                zoom: 5.2,
                pitch: 45,
                bearing: 0.00
            },
